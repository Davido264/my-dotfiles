#!/usr/bin/python3
# original from github.com/caian-org/ansible-stow under CC0-1.0
# credits to Caian R. Ertl <hi@caian.org>
...
short_description: Stow packages

# If this is part of a collection, you need to use semantic versioning,
# i.e. the version is of the form "2.5.0" and not "2.4".
version_added: "1.0.0"

description: Stow packages into target.

options:
    dir:
        required: true
        type: str
        description: Path of the Stow directory
    package:
        required: true
        type: str
        description: Name of the Stow package
    target:
        required: false
        type: str
        description: Path of target directory to perform, defaults to users home directory
    state:
        required: false
        type: str
        description:
...
def purge_conflicts(conflicted_files):
    ...
    try:
        ...
        return {'message': f'unable to purge file "{f}"; error: {str(err)}'}
